...
public class Monitor extends AppCompatActivity {
    ...
    private void setData(){
        ...
        float[] ys1 = new float[]{24f, 24.5f, 23.5f, 24f, 23f, 24f,23f};
        // 模拟数据2
        List<Entry> yVals2 = new ArrayList<>();
        float[] ys2 = new float[]{20f, 22f, 20f, 22f, 20f, 22f,20f};
        // 模拟数据3
        List<Entry> yVals3 = new ArrayList<>();
        float[] ys3= new float[]{18f, 16f, 18f, 16f, 18f, 16f,18f};
        ...
        //将每一组折线数据集添加到折线数据中
        LineData lineData = new LineData(lineDataSet1,lineDataSet3);
        //设置颜色
