...
class main(QtWidgets.QMainWindow,Ui_MainWindow):
    ...
    def __init__(self):
        ...
        # self.webwidget.load(QtCore.QUrl("./robot.html"))
        self.webwidget.load(QtCore.QUrl("https://ditu.amap.com/"))
        ...
        self.pushButton_12.clicked.connect(self.sendip_start)
        ...
        self.pushButton_13.clicked.connect(self.upload)
    ...
    def sendip(self):
        self.ip = self.lineEdit_11.text()
        print(self.ip)
        s = socket.socket()
        port = 1717
        s.connect((str(self.ip), port))
    def sendip_start(self):
        threading_ip = threading.Thread(target=self.sendip)
        threading_ip.start()
    def restart(self):
