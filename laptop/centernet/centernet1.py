...
class CenterNet(object):
    _defaults = {  ####Epoch1200-Total_Loss1.4515-Val_Loss1.8970.pth
        "model_path": 'E:\mushuai\centernet-pytorch\logs\Epoch1000-Total_Loss1.6163-Val_Loss0.9350.pth',
    # 'model_data/centernet_resnet50_voc.pth',Epoch1000-Total_Loss1.6163-Val_Loss0.9350
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='model_data/simhei.ttf',
                                  size=np.floor(3e-2 * np.shape(image)[1]).astype('int32'))
